    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav me-auto" style="margin-left:350px">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" style="margin-left: 40px; font-weight: bold;" href="#">LIÊN HỆ</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" style="margin-left: 40px; font-weight: bold;" href="#">VỀ CHÚNG TÔI</a>
                </li>
